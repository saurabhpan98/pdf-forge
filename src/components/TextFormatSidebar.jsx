        ...
        <Section title="Outline">
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={() => {
                if (activeStyle.outlineColor) {
                  patch({ outlineColor: null, outlineWidth: 0 });
                } else {
                  patch({ outlineColor: [0, 0, 0], outlineWidth: 1 });
                }
              }}
              ...
              title={activeStyle.outlineColor ? 'Disable outline' : 'Enable outline'}
            />
            <input
              type="number"
